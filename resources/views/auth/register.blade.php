        ...
        <div class="col-md-6">
            <div class="card shadow-lg border-0 rounded-lg" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                <div class="card-header text-center" style="background: rgba(255, 255, 255, 0.1); border-bottom: none;">
                    <h1 class="h3 mb-0" style="font-weight: 600;">Create Your Account</h1>
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Nama" required style="border-radius: 10px;">
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Konfirmasi Password" required style="border-radius: 10px;">
                    ...
                    <div class="text-center mt-3">
                        <p class="mb-0">Already have an account? <a href="{{ route('login') }}" class="text-light fw-bold" style="text-decoration: underline;">Login here</a></p>
                    </div>
                </div>
            </div>
        </div>
